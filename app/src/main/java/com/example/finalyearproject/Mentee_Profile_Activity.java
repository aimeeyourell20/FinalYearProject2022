    ...
    protected void onActivityResult(int requestCode, int resultCode, @Nullable Intent data) {
        ...
        if(requestCode==CropImage.CROP_IMAGE_ACTIVITY_REQUEST_CODE){
            ...
            if(resultCode==RESULT_OK) {
                                ...
                                dr.child("profileimage").setValue(url).addOnCompleteListener(new OnCompleteListener<Void>() {
                                    ...
                                    public void onComplete(@NonNull Task<Void> task) {
                                        ...
                                        if (task.isSuccessful()) {
                                            ...
                                            Intent i = new Intent(Mentee_Profile_Activity.this, Mentee_Profile_Activity.class);
                                            startActivity(i);

                                            Toast.makeText(Mentee_Profile_Activity.this, "Profile image stored to firebase database successfully", Toast.LENGTH_SHORT).show();

                                        } else {


                                            Toast.makeText(Mentee_Profile_Activity.this, "Error", Toast.LENGTH_SHORT).show();
                ...
                Toast.makeText(Mentee_Profile_Activity.this, "Error image can not be cropped", Toast.LENGTH_SHORT).show();
