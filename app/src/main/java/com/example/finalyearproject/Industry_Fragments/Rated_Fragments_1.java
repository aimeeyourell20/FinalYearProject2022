...
public class Rated_Fragments_1 extends Fragment {
    ...
    public void skill(String searchBoxInput1) {
        ...
        Query searchPeopleAndFriendsQuery = dr.orderByChild("AverageRating").equalTo(1);
        FirebaseRecyclerAdapter<FindMentor, Rated_Fragments_1.FindMentorViewHolder> firebaseRecyclerAdapter =
                new FirebaseRecyclerAdapter<FindMentor, Rated_Fragments_1.FindMentorViewHolder>(
                        FindMentor.class,
                        R.layout.all_mentors_displayed,
                        Rated_Fragments_1.FindMentorViewHolder.class,
                        searchPeopleAndFriendsQuery

                ) {
                    @Override
                    protected void populateViewHolder(Rated_Fragments_1.FindMentorViewHolder findMentorViewHolder, FindMentor findMentor, int i) {
