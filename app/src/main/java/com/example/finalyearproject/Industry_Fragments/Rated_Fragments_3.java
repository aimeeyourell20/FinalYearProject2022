...
public class Rated_Fragments_3 extends Fragment {
    ...
    public void skill(String searchBoxInput1) {
        ...
        Query searchPeopleAndFriendsQuery = dr.orderByChild("AverageRating").equalTo(3);
        FirebaseRecyclerAdapter<FindMentor, Rated_Fragments_3.FindMentorViewHolder> firebaseRecyclerAdapter =
                new FirebaseRecyclerAdapter<FindMentor, Rated_Fragments_3.FindMentorViewHolder>(
                        FindMentor.class,
                        R.layout.all_mentors_displayed,
                        Rated_Fragments_3.FindMentorViewHolder.class,
                        searchPeopleAndFriendsQuery

                ) {
                    @Override
                    protected void populateViewHolder(Rated_Fragments_3.FindMentorViewHolder findMentorViewHolder, FindMentor findMentor, int i) {
