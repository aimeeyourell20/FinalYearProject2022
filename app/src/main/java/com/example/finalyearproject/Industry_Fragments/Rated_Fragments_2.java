...
public class Rated_Fragments_2 extends Fragment {
    ...
    public void skill(String searchBoxInput1) {
        ...
        Query searchPeopleAndFriendsQuery = dr.orderByChild("AverageRating").equalTo(2);
        FirebaseRecyclerAdapter<FindMentor, Rated_Fragments_2.FindMentorViewHolder> firebaseRecyclerAdapter =
                new FirebaseRecyclerAdapter<FindMentor, Rated_Fragments_2.FindMentorViewHolder>(
                    ...
                    @Override
                    protected void populateViewHolder(Rated_Fragments_2.FindMentorViewHolder findMentorViewHolder, FindMentor findMentor, int i) {
