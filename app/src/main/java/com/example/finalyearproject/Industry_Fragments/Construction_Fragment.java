...
public class Construction_Fragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View = inflater.inflate(R.layout.fragment_construction_, container, false);
    ...
    public void skill(String searchBoxInput1) {
        ...
        FirebaseRecyclerAdapter<FindMentor, Construction_Fragment.FindMentorViewHolder> firebaseRecyclerAdapter =
                new FirebaseRecyclerAdapter<FindMentor, Construction_Fragment.FindMentorViewHolder>(
                        FindMentor.class,
                        R.layout.all_mentors_displayed,
                        Construction_Fragment.FindMentorViewHolder.class,
                        searchPeopleAndFriendsQuery

                ) {
                    @Override
                    protected void populateViewHolder(Construction_Fragment.FindMentorViewHolder findMentorViewHolder, FindMentor findMentor, int i) {
