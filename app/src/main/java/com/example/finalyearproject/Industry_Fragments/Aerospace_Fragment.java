...
public class Aerospace_Fragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View = inflater.inflate(R.layout.fragment_aerospace_, container, false);
    ...
    public void skill(String searchBoxInput1) {
        ...
        FirebaseRecyclerAdapter<FindMentor, Aerospace_Fragment.FindMentorViewHolder> firebaseRecyclerAdapter =
                        new FirebaseRecyclerAdapter<FindMentor, Aerospace_Fragment.FindMentorViewHolder>(
                                FindMentor.class,
                                R.layout.all_mentors_displayed,
                                Aerospace_Fragment.FindMentorViewHolder.class,
                                searchPeopleAndFriendsQuery

                        ) {
                            @Override
                            protected void populateViewHolder(Aerospace_Fragment.FindMentorViewHolder findMentorViewHolder, FindMentor findMentor, int i) {
