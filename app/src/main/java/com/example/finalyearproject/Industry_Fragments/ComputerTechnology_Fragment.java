...
public class ComputerTechnology_Fragment extends Fragment {
    ...
    public ComputerTechnology_Fragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View = inflater.inflate(R.layout.fragment_computer_technology_, container, false);
    ...
    public void skill(String searchBoxInput1) {
        ...
        FirebaseRecyclerAdapter<FindMentor, ComputerTechnology_Fragment.FindMentorViewHolder> firebaseRecyclerAdapter =
                new FirebaseRecyclerAdapter<FindMentor, ComputerTechnology_Fragment.FindMentorViewHolder>(
                    ...
                    @Override
                    protected void populateViewHolder(ComputerTechnology_Fragment.FindMentorViewHolder findMentorViewHolder, FindMentor findMentor, int i) {
                        ...
                        if(!findMentor.getIndustry().equalsIgnoreCase("Computer and Technology")){
                            findMentorViewHolder.itemView.setVisibility(View.GONE);
                            findMentorViewHolder.itemView.setLayoutParams(new RecyclerView.LayoutParams(0, 0));
                        }
                        else {
