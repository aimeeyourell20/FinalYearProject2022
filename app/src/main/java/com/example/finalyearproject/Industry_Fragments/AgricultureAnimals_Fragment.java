...
public class AgricultureAnimals_Fragment extends Fragment {
    ...
    public AgricultureAnimals_Fragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View = inflater.inflate(R.layout.fragment_agriculture_animals_, container, false);
    ...
    public void skill(String searchBoxInput1) {
        ...
        FirebaseRecyclerAdapter<FindMentor, AgricultureAnimals_Fragment.FindMentorViewHolder> firebaseRecyclerAdapter =
                new FirebaseRecyclerAdapter<FindMentor, AgricultureAnimals_Fragment.FindMentorViewHolder>(
                        FindMentor.class,
                        R.layout.all_mentors_displayed,
                        AgricultureAnimals_Fragment.FindMentorViewHolder.class,
                        searchPeopleAndFriendsQuery

                ) {
                    @Override
                    protected void populateViewHolder(AgricultureAnimals_Fragment.FindMentorViewHolder findMentorViewHolder, FindMentor findMentor, int i) {
                        ...
                        if(!findMentor.getIndustry().equalsIgnoreCase("Agriculture/Animals")){
                            findMentorViewHolder.itemView.setVisibility(View.GONE);
                            findMentorViewHolder.itemView.setLayoutParams(new RecyclerView.LayoutParams(0, 0));
                        }
                        else {
