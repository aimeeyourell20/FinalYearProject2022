...
public class Rated_Fragments extends Fragment {
    ...
    public void skill(String searchBoxInput1) {
        ...
        Query searchPeopleAndFriendsQuery = dr.orderByChild("AverageRating").equalTo(5);
        FirebaseRecyclerAdapter<FindMentor, Rated_Fragments.FindMentorViewHolder> firebaseRecyclerAdapter =
                new FirebaseRecyclerAdapter<FindMentor, Rated_Fragments.FindMentorViewHolder>(
                    ...
                    @Override
                    protected void populateViewHolder(Rated_Fragments.FindMentorViewHolder findMentorViewHolder, FindMentor findMentor, int i) {
