...
public class Organisational_Fragment extends Fragment {
    ...
    public Organisational_Fragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View = inflater.inflate(R.layout.fragment_organisational_, container, false);
    ...
    public void industry(String searchBoxInput1) {
        ...
        FirebaseRecyclerAdapter<FindMentor, Organisational_Fragment.FindMentorViewHolder> firebaseRecyclerAdapter =
                new FirebaseRecyclerAdapter<FindMentor, Organisational_Fragment.FindMentorViewHolder>(
                        FindMentor.class,
                        R.layout.all_mentors_displayed,
                        Organisational_Fragment.FindMentorViewHolder.class,
                        searchPeopleAndFriendsQuery

                ) {
                    @Override
                    protected void populateViewHolder(Organisational_Fragment.FindMentorViewHolder findMentorViewHolder, FindMentor findMentor, int i) {
                        ...
                        if(!findMentor.getSkill3().equalsIgnoreCase("Organisational")){
                            findMentorViewHolder.itemView.setVisibility(View.GONE);
                            findMentorViewHolder.itemView.setLayoutParams(new RecyclerView.LayoutParams(0, 0));
                        }
                        else {
