...
public class Collaboration_Fragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View = inflater.inflate(R.layout.fragment_collaboration_, container, false);
    ...
    public void industry(String searchBoxInput1) {
        ...
        FirebaseRecyclerAdapter<FindMentor, Collaboration_Fragment.FindMentorViewHolder> firebaseRecyclerAdapter =
                new FirebaseRecyclerAdapter<FindMentor, Collaboration_Fragment.FindMentorViewHolder>(
                    ...
                    @Override
                    protected void populateViewHolder(Collaboration_Fragment.FindMentorViewHolder findMentorViewHolder, FindMentor findMentor, int i) {
                        ...
                        if(!findMentor.getSkill3().equalsIgnoreCase("Collaboration")){
                            findMentorViewHolder.itemView.setVisibility(View.GONE);
                            findMentorViewHolder.itemView.setLayoutParams(new RecyclerView.LayoutParams(0, 0));
                        }
                        else {
