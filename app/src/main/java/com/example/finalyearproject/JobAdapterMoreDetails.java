...
public class JobAdapterMoreDetails extends RecyclerView.Adapter<JobAdapterMoreDetails.ExampleViewHolder> {
    ...
    public JobAdapterMoreDetails(Context context, ArrayList<Jobs> exampleList) {
        mContext = context;
