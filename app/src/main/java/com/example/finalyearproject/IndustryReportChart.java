...
public class IndustryReportChart extends AppCompatActivity {
        ...
        databaseReference.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                for(DataSnapshot dataSnapshot : snapshot.getChildren()){
                    switch(dataSnapshot.child("industry").getValue(String.class)){ //This statement is seeing what "category" is.
                        case "Aerospace":
                            ++Aerospace;
                    ...
                    pieChart.setCenterText("Industry");
                    pieChart.animate();
                }
            }
