...
public class Message_Mentee extends AppCompatActivity
{
    ...
    {
        RootRef.child("Messages").child(messageSenderID).child(messageReceiverID1).addChildEventListener(new ChildEventListener()
        {
            @Override
    ...
    private void SendMessage()
    {
        ...
        {
            String message_sender_ref = "Messages/" + messageSenderID + "/" + messageReceiverID1;
            String message_receiver_ref = "Messages/" + messageReceiverID1 + "/" + messageSenderID;

            DatabaseReference user_message_key = RootRef.child("Messages").child(messageSenderID).child(messageSenderID).child(messageReceiverID1).push();
            ...
            RootRef.updateChildren(messageBodyDetails).addOnCompleteListener(new OnCompleteListener()
            {
                ...
                public void onComplete(@NonNull Task task)
                {
                    ...
                    else
                    {
                        ...
                        Toast.makeText(Message_Mentee.this, "Error Occur: " + message, Toast.LENGTH_SHORT).show();
                        userMessageInput.setText("");
                    }
                }
            });
...
*/
    private void DisplayReceiverInfo()
    {
        ...
        RootRef.child("users").child(messageReceiverID1).addValueEventListener(new ValueEventListener()
        {
            @Override
