...
public class IndustryMenteeReportChartPie extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_industry_mentee_report_chart_pie);
        ...
        databaseReference.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                for(DataSnapshot dataSnapshot : snapshot.getChildren()){
                    switch(dataSnapshot.child("industry2").getValue(String.class)){ //This statement is seeing what "category" is.
                        case "Aerospace":
                            ++Aerospace;
                    ...
                    PieDataSet pieDataSet = new PieDataSet(garage, "Mentees Industry of Interest");
                    ...
                    pieChart.setCenterText("Mentees Industry of Interest");
                    pieChart.animate();
                }
            }
