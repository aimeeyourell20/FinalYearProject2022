...
public class LocationReportChart extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        home.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent i = new Intent(LocationReportChart.this, MentorMainActivity.class);
                startActivity(i);
                finish();
            }
        });
        ...
        asia.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent i = new Intent(LocationReportChart.this, AsiaReportChartBar.class);
                startActivity(i);
        ...
        australia.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent i = new Intent(LocationReportChart.this, AustraliaReportChartPie.class);
                startActivity(i);
            }
        });
        ...
        middleEast.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent i = new Intent(LocationReportChart.this, MiddleEastReportChartBar.class);
                startActivity(i);
            }
        });
        ...
        northAmerica.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent i = new Intent(LocationReportChart.this, NorthAmericanReportChartPie.class);
                startActivity(i);
            }
        });
        ...
        southAmerica.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent i = new Intent(LocationReportChart.this, SouthAmericaReportChartBar.class);
                startActivity(i);
            }
        });
        ...
        europe.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent i = new Intent(LocationReportChart.this, EuropeReportChartBar.class);
                startActivity(i);
            }
        });
