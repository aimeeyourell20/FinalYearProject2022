...
public class Goals_In_Progress_Mentor extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mHome.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent i = new Intent(Goals_In_Progress_Mentor.this, MentorMainActivity.class);
                startActivity(i);
                finish();
            }
        });
    ...
    private void FetchMessages() {
        ...
        RootRef.child("Goals").child(FirebaseAuth.getInstance().getUid()).child(menteeID).addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                goals_adapterMentee = new Goals_Adapter_Mentor(Goals_In_Progress_Mentor.this, goals_models);
                menteeRecyclerView.setAdapter(goals_adapterMentee);
            ...
            public void onCancelled(@NonNull DatabaseError error) {
                ...
                Toast.makeText(Goals_In_Progress_Mentor.this, "Error", Toast.LENGTH_SHORT).show();
