...
public class Goals_Completed_Mentor extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mHome.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent i = new Intent(Goals_Completed_Mentor.this, MentorMainActivity.class);
                startActivity(i);
                finish();
            }
        });
    ...
    private void FetchMessages() {
        ...
        RootRef.child("Goals").child(FirebaseAuth.getInstance().getUid()).child(menteeID).addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                for(DataSnapshot uniqueKeySnapshot : snapshot.getChildren()){
                    for(DataSnapshot a : uniqueKeySnapshot.getChildren()) {
                        ...
                        if(status.equals("Completed")){
                            ...
                            Toast.makeText(Goals_Completed_Mentor.this, "Not Available", Toast.LENGTH_SHORT).show();
                ...
                goals_adapterMentee = new Goals_Adapter_Mentor(Goals_Completed_Mentor.this, goals_models);
                menteeRecyclerView.setAdapter(goals_adapterMentee);
            ...
            public void onCancelled(@NonNull DatabaseError error) {
                ...
                Toast.makeText(Goals_Completed_Mentor.this, "Error", Toast.LENGTH_SHORT).show();
