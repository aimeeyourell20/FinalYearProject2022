...
public class Goals_In_Progress_Mentee extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mHome.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent i = new Intent(Goals_In_Progress_Mentee.this, MenteeMainActivity.class);
                startActivity(i);
                finish();
            }
        });
    ...
    private void FetchMessages() {
        ...
        RootRef.child("Goals").child(FirebaseAuth.getInstance().getUid()).child(menteeID).addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                for(DataSnapshot uniqueKeySnapshot : snapshot.getChildren()){
                    for(DataSnapshot a : uniqueKeySnapshot.getChildren()) {
                        ...
                        if(status.equals("In progress")){
                            ...
                            Toast.makeText(Goals_In_Progress_Mentee.this, "Not Available", Toast.LENGTH_SHORT).show();
                ...
                goals_adapterMentee = new Goals_Adapter_Mentor(Goals_In_Progress_Mentee.this, goals_models);
                menteeRecyclerView.setAdapter(goals_adapterMentee);
            ...
            public void onCancelled(@NonNull DatabaseError error) {
                ...
                Toast.makeText(Goals_In_Progress_Mentee.this, "Error", Toast.LENGTH_SHORT).show();
