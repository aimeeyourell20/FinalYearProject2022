...
public class Meetings_Activity_Mentor extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (intent != null) {
            ...
            if (extras != null) {
                messageReceiverID = (String) extras.get("menteeid");
            }
        }
    ...
    private void FetchMessages() {
        ...
        RootRef.child("Meetings").child(FirebaseAuth.getInstance().getUid()).child(messageReceiverID).addValueEventListener(new ValueEventListener() {
            @Override
